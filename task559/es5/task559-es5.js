...
function getAllSmallerMersenneNumbers(n) {
    ...
    var SIMPLE_MERSENNE_NUMBERS = [3, 7, 31, 127, 8191, 131071, 524287, 2147483647, 2305843009213693951, 618970019642690137449562111, 162259276829213363391578010288127, 170141183460469231731687303715884105727, /* 39 digits */
    68647976601306097149e137, /* 157 digits */
    53113799281676709868e163, /* 183 digits - max number JS able to handle */
    10407932194664399081e366];
    ...
    for (var i = 0; i < SIMPLE_MERSENNE_NUMBERS.length; i++) {
 ...
 * @type {Array|String}
 */
console.log(getAllSmallerMersenneNumbers(524288), // [3, 7, 31, 127, 8191, 131071, 524287]
